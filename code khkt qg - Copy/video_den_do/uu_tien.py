...
cap = cv2.VideoCapture("den_do.mp4")
...
#fgbg=cv2.bgsegm.createBackgroundSubtractorMOG()#detectShadows=True)
...
while True:
    ...
    cv2.line(frame, (0, 90), (460, 90), (0, 0, 255), 2)
    cv2.line(frame, (0, 100), (460,100), (0, 0, 255), 2)

    cv2.line(frame, (0, 140), (460, 140), (0, 0, 255), 2)
